...
export default function ViewMatches() {
  ...
  const getWinnerHighlight = (match, team) => {
    ...
    if ((team === 'home' && match.winner === 'HOME_TEAM') ||
    ...
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ display: 'flex', gap: '10px', marginBottom: '20px' }}>
        ...
        <button
          ...
          style={{
            padding: '10px 20px',
            backgroundColor: selectedStatus === 'upcoming' ? '#3b82f6' : '#f3f4f6',
                ...
                >
                  ...
                  <div style={{
                    ...
                    <div style={{ fontSize: '13px', color: '#6b7280' }}>
                      <strong>{match.league_name}</strong> • Matchday {match.matchday}
                    </div>
            ...
            <div style={{
              ...
              <div>
                <div style={{ fontSize: '14px', color: '#6b7280', marginBottom: '5px' }}>
                  {selectedMatch.league_name} • Matchday {selectedMatch.matchday}
                </div>
                <div style={{ fontSize: '12px', color: '#9ca3af' }}>
                  {new Date(selectedMatch.utc_date).toLocaleDateString('en-US', {
                    weekday: 'long',
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric',
                  ...
                  {selectedMatch.full_time_home !== null ? (
                    <div>
                      <div style={{ fontSize: '48px', fontWeight: 'bold', color: '#1f2937' }}>
                        {selectedMatch.full_time_home} - {selectedMatch.full_time_away}
                      </div>
                      {selectedMatch.half_time_home !== null && (
                        <div style={{ fontSize: '14px', color: '#6b7280', marginTop: '10px' }}>
                          Half Time: {selectedMatch.half_time_home} - {selectedMatch.half_time_away}
                        </div>
                      )}
